...
int main() {
	...
	ray.Eye = { -500, 0, -50 };
	ray.gCenter = { 0, 0, -50 };
	GraphicsFileCode::ppmRead("D:/LIGU.ppm", ray.ScreenPix);
	{
		RayTracing::Material* material;
		Mat<double> p1(3), p2(3), p3(3), p4(3), p5(3);

		material = new RayTracing::Material; material->color = { 1, 1, 1 };
		ray.drawSphere(p1 = { 600, -200, -500 + 200 }, 200, material);
		material = new RayTracing::Material; material->color = { 1, 1, 1 }; material->refractRate = 1.6; material->reflect = 0.1;
		...
		material = new RayTracing::Material; material->color = { 1, 1, 1 }; material->diffuseReflect = 1;
		...
		ray.drawSphere(p1 = { 500, 0, -1e5 - 500 }, 1E5, material);
		material = new RayTracing::Material; material->color = { 10, 10, 10 }; material->rediate = 1;
		ray.drawTriangle(
			p1 = { 500 - 200, -200, 499 },
			p2 = { 500 - 200, 200, 499 },
			p3 = { 500 + 200, 200, 499 },
