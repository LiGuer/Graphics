...
void Model(RayTracing& ray) {
	...
	ray.addPlane(p1 = { 1, 0, 0 }, p2 = { 950, 0, 0 }, material);
	...
	ray.addPlaneShape(p1 = { 0, 1, 0 }, p2 = { 100, -495, -250 }, f1, material);
	...
	ray.addSphere(p1 = { 500,200,-200 + 120 }, 120, material, [](double x, double y) {
		double o = y - ((int)(y / (PI / 2))) * (PI / 2), r = 3 / 2.5 * sin(o) * cos(o) / (pow(sin(o), 3) + pow(cos(o), 3)); if ((PI - x) < asin(r)) return true; return false; });
	ray.addSphere(p1 = { 500,200,-200 + 120 / 3.0 }, 120 / 3.0, material, [](double x, double y) { y += PI / 4;
	...
	material = new RayTracing::Material; material->color = { 1, 1, 0 };	material->diffuseReflect = 1;
	ray.addStl("D:/ligu.stl", p1 = { 300, 200,-500 }, 15, &material);
	//Box
	material = new RayTracing::Material; material->color = { 0.65, 0.62, 1 };	material->diffuseReflect = 1;
	ray.addPlaneShape(p1 = { 0, 1, 0 }, p2 = { 0, +500, 0 }, [](double x, double y) { return x <= 1000 ? true : false; }, material);
	...
	ray.addPlane(p1 = { 1, 0, 0 }, p2 = { 2000, 0, 0 }, material);
	...
	ray.addCircle(p1 = { 1500,0, 499 }, 250, p2 = { 0,0,1 }, material);
